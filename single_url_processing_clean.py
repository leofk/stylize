...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_folder", default=data_path, type=str, help="data_folder path")
    ...
    parser.add_argument("--stylesheet_file", default="data/stylesheets/Professional6_v2.json", type=str, help="stylesheet file path")
